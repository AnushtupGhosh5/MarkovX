  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-lg bg-white/10 hover:bg-white/15 text-white px-4 py-2 text-sm font-medium border border-white/10 transition-colors duration-200"
      >
        {user?.avatar ? (
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 rounded-lg bg-slate-900/95 backdrop-blur-xl border border-white/10 shadow-2xl z-20 overflow-hidden">
